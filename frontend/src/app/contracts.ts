...
export const LendingPoolLiteABI = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract CredRegistry"
      }
    ],
    "stateMutability": "view"
  },
